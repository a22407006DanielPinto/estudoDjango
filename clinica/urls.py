...
urlpatterns=[
    ...
    path('editar/criar/<int:id>/', views.editar_consulta_view, name='editar_consulta_view'),
    path('apagar/criar/<int:id>/', views.apagar_consulta_view, name='apagar_consulta_view'),
